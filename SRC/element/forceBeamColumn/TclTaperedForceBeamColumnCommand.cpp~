                                          ...
                                          theTclBuilder)
{
	...
	printf("Before checking the iteration\n");
        ...
        if (ndm == 3) {
            if (strcmp(argv[1], "elasticForceBeamColumn") == 0)
                theElement =
                    new ElasticForceBeamColumn3d(eleTag, iNode, jNode,
                                                 nIP, sections,
                                                 *beamIntegr,
                                                 *theTransf3d);
	    ...
	    else if (strcmp(argv[1], "TapereddispBeamColumnS") == 0) {
		theElement = 
		    new TaperedDispBeamColumnSmoothing3d(eleTag, iNode, jNode, nIP, sections, *beamIntegr, 
                ...
                theElement =
                    new ForceBeamColumn3d(eleTag, iNode, jNode, nIP, sections, *beamIntegr,
                                          *theTransf3d, mass, numIter, tol);
	    }
        }
    ...
    if (strcmp(argv[1], "TaperedDispBeamColumn") == 0) {
	#ifdef DEBUG
	    fprintf(stdout, "About to hit TaperedDispBeamColumn3d again\n");
	#endif
	theElement = new TaperedDispBeamColumn3d(eleTag, iNode, jNode, numSections, 
						 sections, *beamIntegr, *theTransf3d);  // Modified for Tapered Study
    }
    else {
	theElement = new TaperedDispBeamColumnSmoothing3d(eleTag, iNode, jNode, 
							  numSections, sections, *beamIntegr, 
							  *theTransf3d);                // Modified for Tapered Study
    }
