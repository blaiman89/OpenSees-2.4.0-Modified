...
FEM_ObjectBrokerAllClasses::getNewElement(int classTag)
{
	...
	// Brighton Laiman: University of California, San Diego
	case ELE_TAG_TaperedDispBeamColumn3d: 
	     return new TaperedDispBeamColumn3d();

	case ELE_TAG_TaperedDispBeamColumnSmoothing3d: 
	     return new TaperedDispBeamColumnSmoothing3d();
	// [END] B.L.
...
FEM_ObjectBrokerAllClasses::getNewCrdTransf(int classTag)
{
	...
	// Brighton Laiman: University of California, San Diego
	case CRDTR_TAG_LinearCrdTransf3d14:
		return new LinearCrdTransf3d14(); 

	case CRDTR_TAG_PDeltaCrdTransf3d14:
		return new PDeltaCrdTransf3d14(); 

	case CRDTR_TAG_CorotCrdTransf3d14:
		return new CorotCrdTransf3d14();
	// [END] B.L.
