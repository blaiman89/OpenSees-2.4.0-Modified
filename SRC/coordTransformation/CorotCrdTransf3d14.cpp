...
// $Source: /usr/local/cvs/OpenSees/SRC/coordTransformation/CorotCrdTransf3d14.cpp,v $
...
// CorotCrdTransf3d14 class. CorotCrdTransf3d14 is a Corot
...
#include <CorotCrdTransf3d14.h>
using std::string;
using namespace std;

// initialize static variables
Matrix CorotCrdTransf3d14::RI(3,3); 
Matrix CorotCrdTransf3d14::RJ(3,3); 
Matrix CorotCrdTransf3d14::Rbar(3,3); 
Matrix CorotCrdTransf3d14::e(3,3); 
Matrix CorotCrdTransf3d14::Tp(9,9); 
Matrix CorotCrdTransf3d14::A(3,3);
Matrix CorotCrdTransf3d14::Lr2(14,3); // chagne dimension of the matrix to suit for warping degrees
Matrix CorotCrdTransf3d14::Lr3(14,3);  // chagne dimension of the matrix to suit for warping degrees
Matrix CorotCrdTransf3d14::T(9,14);   // chagne dimension of the matrix to suit for warping degrees


// constructor:
CorotCrdTransf3d14::CorotCrdTransf3d14(int tag, const Vector &vecInLocXZPlane,
                                   const Vector &rigJntOffsetI,
                                   const Vector &rigJntOffsetJ):
CrdTransf(tag, CRDTR_TAG_CorotCrdTransf3d14),
...
nodeIInitialDisp(0), nodeJInitialDisp(0), initialDispChecked(false)
{
    ...
    {
        opserr << "CorotCrdTransf3d14::CorotCrdTransf3d14:  Vector that defines local xz plane is invalid\n";
    ...
    {
        opserr << "CorotCrdTransf3d14::CorotCrdTransf3d14:  Invalid rigid joint offset vector for node I\n";
        opserr << "Size must be 3\n";      
        nodeIOffset.Zero();      
    }
    else
    ...
    {
        opserr << "CorotCrdTransf3d14::CorotCrdTransf3d14:  Invalid rigid joint offset vector for node J\n";
        opserr << "Size must be 3\n";      
        nodeJOffset.Zero(); 
    }
    else
    ...
    {
        opserr << "CorotCrdTransf3d14::CorotCrdTransf3d14: rigid joint zones not implemented yet\n";
    ...
    //       Tp is identity(9) but swap sign on 2 and 6 (rotations about y)
...
CorotCrdTransf3d14::CorotCrdTransf3d14():
CrdTransf(0, CRDTR_TAG_CorotCrdTransf3d14),
vAxis(3), nodeIOffset(3), nodeJOffset(3), xAxis(3),
nodeIPtr(0), nodeJPtr(0), R0(3,3), L(0), Ln(0), 
alphaIq(4), alphaJq(4), 
alphaIqcommit(4), alphaJqcommit(4), alphaI(3), alphaJ(3),
...
int
CorotCrdTransf3d14::commitState(void)
{
    ulcommit      = ul;
...
int
CorotCrdTransf3d14::revertToLastCommit(void)
{
    ...
    #ifdef DEBUG
	fprintf(stdout, "CorotCrdTransf3d14::revertToLastCommit\n");
    #endif
...
int
CorotCrdTransf3d14::revertToStart(void)
{
    ul.Zero();
    ...
    #ifdef DEBUG
	fprintf(stdout, "CorotCrdTransf3d14::revertToStart\n");
    #endif
...
int 
CorotCrdTransf3d14::initialize(Node *nodeIPointer, Node *nodeJPointer)
{       
    int error;
...
int  
CorotCrdTransf3d14::update(void)
{       
    ...
    **************************************************************/
    ...
    for (i = 0; i < 3; i++)
        for (j = 0; j < 3; j++)
            ...
            if (Ln == 0.0) 
            {
                opserr << "\nCorotCrdTransf3d14::update: 0 deformed length\n";
                return -2;  
            }
...
void
CorotCrdTransf3d14::compTransfMatrixBasicGlobal(void)
{
...
void
CorotCrdTransf3d14::compTransfMatrixBasicGlobalNew(void)
{
    // extract columns of rotation matrices
    int i, j, k;
...
const Vector &
CorotCrdTransf3d14::getBasicTrialDisp (void)
{
    static Vector ub(9);
...
const Vector &
CorotCrdTransf3d14::getBasicIncrDeltaDisp (void)
{
    static Vector dub(9);
    static Vector dul(9);
...
const Vector &
CorotCrdTransf3d14::getBasicIncrDisp(void)
{
    static Vector Dub(9);
    static Vector Dul(9);
...
const Vector &
CorotCrdTransf3d14::getBasicTrialVel(void)
{
    opserr << "ERROR CorotCrdTransf3d14::getBasicTrialVel()"
...
const Vector &
CorotCrdTransf3d14::getBasicTrialAccel(void)
{
    opserr << "ERROR CorotCrdTransf3d14::getBasicTrialAccel()"
        << " - has not been implemented yet." << endln;
...
const Vector &
CorotCrdTransf3d14::getGlobalResistingForce(const Vector &pb, const Vector &unifLoad)
{
   ...
   const Matrix &
CorotCrdTransf3d14::getGlobalStiffMatrix (const Matrix &kb, const Vector &pb)
{
...
const Matrix &
CorotCrdTransf3d14::getInitialGlobalStiffMatrix (const Matrix &kb)
{
    // transform tangent stiffness matrix from the basic system to local coordinates
    static Matrix kl(9,9);
...
int 
CorotCrdTransf3d14::getLocalAxes(Vector &XAxis, Vector &YAxis, Vector &ZAxis)
{
    // element projection
    ...
    if (L == 0.0) 
    {
        opserr << "\nCorotCrdTransf3d14::computeElemtLengthAndOrien: 0 length\n";
        return -2;  
    }
    ...
    if (ynorm == 0)
    {
        opserr << "\nCorotCrdTransf3d14::getElementLengthAndOrientation";
...
double 
CorotCrdTransf3d14::getInitialLength(void)
{
    return L;
}
...
double 
CorotCrdTransf3d14::getDeformedLength(void)
{
    return Ln;
}
...
const Vector &
CorotCrdTransf3d14::getQuaternionFromRotMatrix(const Matrix &R) const
{
...
const Vector &
CorotCrdTransf3d14::getQuaternionFromPseudoRotVector(const Vector  &theta) const
{
...
const Vector &
CorotCrdTransf3d14::quaternionProduct(const Vector &q1, const Vector &q2) const
{
...
const Matrix &
CorotCrdTransf3d14::getRotationMatrixFromQuaternion(const Vector &q) const
{ 
    int i, j;
    double factor;
...
const Vector &
CorotCrdTransf3d14::getTangScaledPseudoVectorFromQuaternion(const Vector &q) const
{ 
    static Vector w(3);
...
const Matrix &
CorotCrdTransf3d14::getRotMatrixFromTangScaledPseudoVector(const Vector &w) const
{ 
...
const Matrix &
CorotCrdTransf3d14::getSkewSymMatrix (const Vector &theta) const
{
    static Matrix S(3,3);
...
const Matrix &
CorotCrdTransf3d14::getLMatrix (const Vector &ri) const
{
...
const Matrix &
CorotCrdTransf3d14::getKs2Matrix (const Vector &ri, const Vector &z) const
{
...
CrdTransf *
CorotCrdTransf3d14::getCopy3d(void)
{
    // create a new instance of CorotCrdTransf3d14 
    
    CorotCrdTransf3d14 *theCopy = new CorotCrdTransf3d14 (this->getTag(), vAxis, nodeIOffset, nodeJOffset);
    
    if (!theCopy)
    {
        opserr << "CorotCrdTransf3d14::getCopy() - out of memory creating copy\n";
        exit(-1);
        return 0;
    }    
...
int 
CorotCrdTransf3d14::sendSelf(int cTag, Channel &theChannel)
{
    Vector data(48);
    // basic/natural deformations
    for (int i=0; i<9; i++) 
        data(i) = ulcommit(i);
    for (int j=0; j<4; j++) {
        data(9+j)  = alphaIqcommit(j);
        data(12+j) = alphaJqcommit(j);
    }
    
    for (int k=0; k<3; k++) {
        data(16+k) = xAxis(k);
        data(19+k) = vAxis(k);
        data(22+k) = nodeIOffset(k);
        data(25+k) = nodeJOffset(k);
        data(28+k) = alphaI(k);
        data(31+k) = alphaJ(k);
    }
    ...
    if (nodeJInitialDisp != 0) {
        data(41) = nodeJInitialDisp[0];
        data(42) = nodeJInitialDisp[1];
        data(43) = nodeJInitialDisp[2];
        data(44) = nodeJInitialDisp[3];
        data(45) = nodeJInitialDisp[4];
        data(46) = nodeJInitialDisp[5];
        data(47) = nodeJInitialDisp[6];
    } else {
        data(41) = 0.0;
        data(42) = 0.0;
        data(43) = 0.0;
...
int 
CorotCrdTransf3d14::recvSelf(int cTag, Channel &theChannel, FEM_ObjectBroker &theBroker)
{
    Vector data(48);
    ...
    for (i=0; i<9; i++) 
        ulcommit(i) = data(i);
    for (j=0; j<4; j++) {
        alphaIqcommit(j) = data(9+j);
        alphaJqcommit(j) = data(12+j);
    }
    
    for (int k=0; k<3; k++) {
        xAxis(k)       = data(16+k);
        vAxis(k)       = data(19+k); 
        nodeIOffset(k) = data(22+k);
        nodeJOffset(k) = data(25+k);
        alphaI(k)      = data(28+k);
        alphaJ(k)      = data(31+k);
    }
...
const Vector &
CorotCrdTransf3d14::getPointGlobalCoordFromLocal(const Vector &xl)
{
    static Vector xg(3);
    opserr << " CorotCrdTransf3d14::getPointGlobalCoordFromLocal: not implemented yet" ;
...
const Vector &
CorotCrdTransf3d14::getPointGlobalDisplFromBasic (double xi, const Vector &uxb)
{
    static Vector uxg(3);
    opserr << " CorotCrdTransf3d14::getPointGlobalDisplFromBasic: not implemented yet" ;
...
void
CorotCrdTransf3d14::Print(OPS_Stream &s, int flag)
{
    s << "\nCrdTransf: " << this->getTag() << " Type: CorotCrdTransf3d14";
    s << "\tvAxis: " << vAxis;
